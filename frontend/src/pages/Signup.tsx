    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#F7FDF9] px-4 py-12">
      ...
      <div className="w-full max-w-[480px] rounded-2xl border border-slate-200/80 bg-white p-7 shadow-[0_20px_50px_-15px_rgba(15,23,42,0.12)] sm:p-9">
        ...
        <form className="mt-6 flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`flex h-4 w-4 items-center justify-center rounded-full border ${
                      role === "buyer" ? "border-blue-600 bg-blue-600" : "border-slate-300"
                    }`}
                  >
                    {role === "buyer" && <div className="h-1.5 w-1.5 rounded-full bg-white" />}
                  </div>
                </div>

                <div className="mt-3">
                  <h4 className="text-xs font-bold text-slate-900">Buyer</h4>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`flex h-4 w-4 items-center justify-center rounded-full border ${
                      role === "supplier" ? "border-blue-600 bg-blue-600" : "border-slate-300"
                    }`}
                  >
                    {role === "supplier" && <div className="h-1.5 w-1.5 rounded-full bg-white" />}
                  </div>
                </div>

                <div className="mt-3">
                  <h4 className="text-xs font-bold text-slate-900">Supplier</h4>
                  <p className="mt-1 text-[9px] font-medium leading-tight text-slate-400 sm:text-[10px]">
          ...
          <button
            type="submit"
            className="mt-3 inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-[#1E5BFF] py-3 text-xs font-semibold text-white shadow-sm transition-all hover:bg-blue-700 hover:shadow-md sm:text-sm"
          >
            Create Account
          </button>
        </form>
